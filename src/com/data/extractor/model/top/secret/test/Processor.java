package com.data.extractor.model.top.secret.test;
...
import com.data.extractor.model.top.secret.TableDataRetriever;
import com.data.extractor.model.top.secret.TextLocationRetreiver;
...
public class Processor {
    ...
    public static void main(String args[]) throws IOException, CryptographyException {
        ...
        for (TableDataElement ta : tableDataElements) {
            ...
            List<TextData> textDataList = retreiver.processPdf(ta.getPageNumber() - 1);
            ...
            for (; i < textDataList.size(); i++) {
                ...
                for (int a = 0; a < columnList.size(); a++) {
                    ...
                    /* Coded as extension to add the extracted values to the columns */
            ...
            /* Added by niro to add assign the collected values over the upper loop to the columns */
